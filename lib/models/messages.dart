class Messages {
  ...
  @override
  String toString() {
    return 'Messages{number: $number, message: $message, result_number: $result_number, result_message: $result_message, rating_number: $rating_number, rating_sms: $rating_sms, times_marked: $times_marked}';
  }
}
